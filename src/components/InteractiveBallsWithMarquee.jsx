...
const InteractiveBallsWithMarquee = () => {
    ...
    return (
        <div className="relative h-[200vh]">
            ...
            <div className="absolute top-[30%] left-0 w-full overflow-hidden pointer-events-none z-50 h-12 flex items-center">
            ...
            <div ref={ball1Ref} className="absolute top-20 left-1/2 transform -translate-x-1/2 w-20 h-20 border-2 border-black rounded-full"></div>
            <div ref={ball2Ref} className="absolute top-20 left-1/2 transform -translate-x-1/2 w-20 h-20 border-2 border-black rounded-full"></div>
            <div ref={smallBall1Ref} className="absolute top-20 left-1/4 w-10 h-10 border-2 border-black rounded-full"></div>
            <div ref={smallBall2Ref} className="absolute top-20 left-3/4 w-10 h-10 border-2 border-black rounded-full"></div>
            <div ref={smallBall3Ref} className="absolute top-30 left-1/3 w-8 h-8 border-2 border-black rounded-full"></div>
            <div ref={smallBall4Ref} className="absolute top-30 left-2/3 w-8 h-8 border-2 border-black rounded-full"></div>
