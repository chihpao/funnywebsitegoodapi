      ...
      {timelineEvents.map((event, index) => (
        ...
        >
          ...
          <div className="hidden md:flex w-full items-center">
            ...
            {index % 2 === 0 && (
              <motion.div
                className="w-[calc(50%-4rem)] p-6 text-right pr-16"
            ...
            {/* 中央時間點 */}
            <div className="relative z-20 flex-shrink-0 w-32 flex justify-center">
              <motion.div
            ...
            {index % 2 === 1 && (
              <motion.div
                className="w-[calc(50%-4rem)] p-6 text-left pl-16"
                initial={{ opacity: 0, x: 50 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: 0.3 }}
            ...
            {/* 圖片區域 */}
            <motion.div
              className={`w-[calc(50%-4rem)] p-6 ${
                index % 2 === 0 ? "order-last pl-16" : "order-first pr-16"
              }`}
